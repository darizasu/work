...
out_dir <- "C:/Users/Daniel/Desktop/test_data"

# Name of the csv file to store the final results. NA avoids writing such file.
save_table <- "C:/Users/Daniel/Desktop/test_data/Prediction_results.csv"
...
geno <- "C:/Users/Daniel/Desktop/test_data/GBS_Africa_population_repMasked_mi300_annotated_maf0.1_BeagleImpute_annotated_rrBLUP.in"

# samp <- File with the list of genotype names present in the genotypic matrix. One per line.
samp <- "C:/Users/Daniel/Desktop/test_data/GBS_Africa_population_repMasked_mi300_annotated_maf0.1_BeagleImpute_annotated_rrBLUP_samples.txt"
